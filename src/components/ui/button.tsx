  ...
  "inline-flex shrink-0 items-center justify-center gap-2 rounded-[0.95rem] border text-sm font-semibold tracking-[-0.01em] transition-[transform,box-shadow,background-color,border-color,color,opacity] duration-200 ease-out focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-55 active:translate-y-[1px] active:scale-[0.99] motion-reduce:transform-none motion-reduce:transition-none",
  {
    variants: {
      variant: {
        ...
        secondary:
          "glass-control px-4 py-2.5 text-foreground hover:-translate-y-0.5 hover:border-[rgba(199,207,225,0.98)] hover:bg-white hover:shadow-[0_18px_34px_rgba(44,55,91,0.1)]",
        outline:
          "glass-control px-4 py-2.5 text-foreground hover:-translate-y-0.5 hover:border-[rgba(199,207,225,0.98)] hover:bg-white hover:shadow-[0_18px_34px_rgba(44,55,91,0.1)]",
        ghost:
          "border-transparent bg-transparent px-4 py-2.5 text-foreground shadow-none hover:-translate-y-0.5 hover:border-[rgba(219,225,238,0.8)] hover:bg-white/72 hover:shadow-[0_12px_24px_rgba(44,55,91,0.07)]",
        danger:
